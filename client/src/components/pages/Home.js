      ...
      <>
        <ul>
          ...
          <li className="home-page__container">
            <section className="home-page__timer-section">
              <div className="home-page__timer-wrapper">
                ...
                <Accordion allowZeroExpanded="true">
                  <AccordionItem>
                    ...
                    <AccordionItemPanel>
                      <p className="timer-option__description paragraph">
                        ...
                        freaquent breaks. Task List included. Tablet and
                        computer tub session update included.
                      </p>
                  ...
                  <AccordionItem>
                    ...
                    <AccordionItemPanel>
                      <p className="timer-option__description paragraph">
                        ...
                        longer session again (similar to the Pomodoro Method).
                        Use pause button for longer breaks. Task List included.
                        Tablet and computer tub session update included.
                      </p>
                  ...
                  <AccordionItem>
                    ...
                    <AccordionItemPanel>
                      <p className="timer-option__description paragraph">
                        This option can be very helpful if you need to get ready
                        for exams like IELTS. This options allows you to set
                        your own timer, by choosing the length for your main
                        "Work Session", and "Toffee Time" (break session).Use
                        pause button for longer breaks. Task List included.
                        Tablet and computer tub session update included.
                      </p>
              ...
              <div className="home-page__text">
                <h2 className=" paragraph">
                  We recommend that you have an agenda for the day, and write
                  some of your goals for the session. Remember to be realistic
                  about what can be done in a given time. You can start with
                  small tasks and add more later. Good luck!
                </h2>
              </div>
            </section>
